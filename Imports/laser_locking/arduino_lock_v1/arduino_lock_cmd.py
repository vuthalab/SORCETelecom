...
class ArduinoCurrentLocker:
    ...
    def load_from_eeprom(self):
        self.ser.write(b'r') #update the arduino params to match the eeprom params
        self.get_params() #update the local params to match the eeprom params as well
        self.params[5]=1
        self.set_params() 
        
    def save_to_eeprom(self):
        self.ser.write(b'w') #update the eeprom params to match the arduino params
