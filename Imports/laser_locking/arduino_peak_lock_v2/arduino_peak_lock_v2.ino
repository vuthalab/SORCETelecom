...
//    if(params.scan_state == STATE_LOCKING and abs(sig_in-sig_peak_in)<1000) {
//      lock_start_point = sig_out;
//      corr_out = sig_out;
//      //hwhm_jump = sig_out - sig_peak_out; //should be positive number, locking starts at the LOWER voltage side of the peak
//      
//      break;  
//    }
  }
